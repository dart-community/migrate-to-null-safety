...
void main(List<String> arguments) {
  ...
  if (arguments.length != 1) {
    ...
    // Get the file name.
    //
    // TIP: We're using null safe versions of the core libraries, and
    // the type of `arguments` is `List` which means that
    // `arguments` can't contain null elements. As a result,
    // the Dart analyzer knows that `fileName` isn't `null`.
