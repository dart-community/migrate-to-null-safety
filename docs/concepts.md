...
description: >-
  ...
  covering nullable types, flow analysis, the late modifier, and more.
---
...
parameters](https://dart.dev/language/functions#parameters), the handy `?.` null-aware operator, and default initialization. It
...
![Null Safety Hierarchy Before](img/hierarchy-before.png)
...
![Null Safety Hierarchy After](img/hierarchy-after.png)
...
![Nullable type hierarchy](img/nullable-hierarchy.png)
...
![Nullable and Non-Nullable types](img/bifurcate.png)
...
![Top and Bottom types](img/top-and-bottom.png)
...
*   **Instance fields must either have an initializer at the declaration, use an
    [initializing formal](https://dart.dev/language/constructors#use-initializing-formal-parameters),
    or be initialized in the
    [constructor's initialization list](https://dart.dev/language/constructors#use-an-initializer-list).**
    That's a lot of jargon. Here are the examples:
...
For null safety, we've taken this limited analysis and made it
[much more powerful in several ways.][flow analysis]
...
(barring [some particular reasons](https://dart.dev/tools/non-promotion-reasons)).
...
see [Fixing type promotion failures](https://dart.dev/tools/non-promotion-reasons).

### Nullability and generics

Like most modern statically-typed languages, Dart has [generic classes and
generic methods](https://dart.dev/language/generics). They interact with nullability in a few ways that seem
